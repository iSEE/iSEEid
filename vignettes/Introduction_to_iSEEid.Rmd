...
- a **Data parameters** box (bottom) with controls to customize what the
  editor produces, whereas the **Selection paramters** box allows to change the 
  source e.g. for the column selection.

```{r, fig.cap="A basic configuration for using iSEEid.", echo=FALSE}
...
```{r, fig.cap="A somewhat more complex example of iSEEid in action, with some extra panels.", echo=FALSE}
